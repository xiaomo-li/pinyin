// var img = document.querySelector(".c7");
// var canvasWidth; // 全局变量

// function printImgWidth() {
// 	var imgWidth = img.offsetWidth;
// 	console.log("Image width:", imgWidth, "pixels");
// 	canvasWidth = Math.min(imgWidth, $(window).width() - 200);
// }

// setInterval(printImgWidth, 1000); // 每秒钟打印一次

var canvas = document.getElementById("canvas");
var canvasWidth = Math.min(199, $(window).width() - 200);
